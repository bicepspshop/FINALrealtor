    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 bg-white dark:bg-dark-charcoal theme-transition">
        <div className="container-luxury py-16">
          <h1 className="text-3xl md:text-4xl font-serif mb-12 text-luxury-black dark:text-white theme-transition">Реквизиты</h1>
          
          <div className="bg-gray-50 dark:bg-dark-slate p-8 rounded-lg shadow-sm theme-transition max-w-2xl">
            <div className="mb-8">
              <h2 className="text-xl font-medium mb-4 text-luxury-black dark:text-white theme-transition">Индивидуальный предприниматель</h2>
              <p className="text-gray-800 dark:text-gray-200 text-lg mb-2 theme-transition">Анисимов Константин Александрович</p>
              <p className="text-gray-800 dark:text-gray-200 text-lg theme-transition">ИНН: 526319437963</p>
            </div>
            
            <div className="mb-8">
              <h2 className="text-xl font-medium mb-4 text-luxury-black dark:text-white theme-transition">Контактная информация</h2>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-800 dark:text-gray-200 theme-transition">rieltorprorf@mail.ru</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-luxury-gold dark:text-luxury-royalBlue theme-transition">
                    <path d="M3 5C3 3.89543 3.89543 3 5 3H8.27924C8.70967 3 9.09181 3.27543 9.22792 3.68377L10.7257 8.17721C10.8831 8.64932 10.6694 9.16531 10.2243 9.38787L7.96701 10.5165C9.06925 12.9612 11.0388 14.9308 13.4835 16.033L14.6121 13.7757C14.8347 13.3306 15.3507 13.1169 15.8228 13.2743L20.3162 14.7721C20.7246 14.9082 21 15.2903 21 15.7208V19C21 20.1046 20.1046 21 19 21H18C9.71573 21 3 14.2843 3 6V5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="text-gray-800 dark:text-gray-200 theme-transition">+79991378919</span>
                </div>
              </div>
            </div>
          </div>
